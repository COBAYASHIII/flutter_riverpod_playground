...
import 'package:flutter_riverpod_playground/application/weather_notifer.dart';
...
import 'package:flutter_riverpod_playground/presentation/pages/weather_detail_page.dart';
...
//ref.listen<WeatherState>(weatherStateNotifierProvider, (state) {if (state is WeatherError) {ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(state.message),),);}});